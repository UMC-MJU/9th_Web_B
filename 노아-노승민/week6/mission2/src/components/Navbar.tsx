  ...
  return (
    <header className="fixed top-0 left-0 w-full h-16 bg-black border-b border-gray-800 flex items-center justify-between px-6 z-50">
      <div className="flex items-center gap-4">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4">
      ...
      <div className="flex items-center gap-4 text-sm font-medium">
        {isLoggedIn ? (
          <>
            ...
            <button onClick={logout} className="text-gray-400 hover:text-fuchsia-400 transition">
              로그아웃
            </button>
          </>
        ) : (
