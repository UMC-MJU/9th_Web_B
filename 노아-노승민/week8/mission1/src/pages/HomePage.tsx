...
export default function HomePage() {
  ...
  }, [throttledFetchNext, hasNextPage]);
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#121212] text-gray-100 px-6 py-8 mt-16 relative">
        ...
        {isLoading && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {Array.from({ length: 8 }).map((_, i) => (
              <div
                key={i}
                className="animate-pulse bg-gray-800 rounded-lg aspect-square"
              />
            ))}
          </div>
        )}
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="text-sm text-gray-300 mt-1">❤️ {likeCount}</div>
                    </div>
                  </div>
                );
              })
