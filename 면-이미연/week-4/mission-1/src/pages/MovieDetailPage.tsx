...
const MovieDetailPage = () => {
    ...
    const { 
        ...
        error: movieError 
    } = useFetch<MovieDetails>(`/movie/${movieId}?language=ko-KR`);
    
    const { 
        data: credits, 
        loading: creditsLoading, 
        error: creditsError 
    } = useFetch<{ cast: Cast[]; crew: Crew[] }>(`/movie/${movieId}/credits?language=ko-KR`);
    ...
    const cast = credits?.cast.sort((a, b) => b.popularity - a.popularity) ?? [];
